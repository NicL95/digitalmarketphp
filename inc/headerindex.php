...
<head>
    ...
    <link rel="stylesheet" href="util/css/styleindex.css">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse position-fluid badge" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto gap-3 fs-5">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-primary btn btn-outline-secondary" aria-disabled="true" href="produtos/sobre.php">Sobre Nós</a>
                    </li>
