        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse position-fluid badge" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto gap-3 fs-5">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-primary btn btn-outline-secondary" href="../produtos/saldos.php">SALDOS</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-primary btn btn-outline-secondary" aria-disabled="true" href="#contacto">Sobre Nos</a>
                    </li>
                    <li class="nav-item"><a class="nav-link text-primary btn btn-outline-secondary" aria-disabled="true" href="../conta/login.php"><i class="bi bi-person-fill-add"> Iniciar Sessão</i></a>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle text-primary btn btn-outline-secondary" type="button" data-bs-toggle="dropdown" aria-expanded="false"><img src="../util/images/logo.png" width="35px" class="img-fluid rounded-circle"></i>
                            <span>Utilizador logueado</span>
                        </a>
                        <ul class="dropdown-menu bg-light rounded-2">
                            ...
                            <li><a class="dropdown-item text-primary rounded-2" href="#"><i class="bi bi-person-fill-x"> Fechar
                                        Sessão</i></a></li>
                        </ul>
                    </li>
                </ul>
